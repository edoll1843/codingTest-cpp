...
//using namespace std;
//int answer = 0;
//void dfs(vector<vector<int>>computers,int i, int j,int net)
//{
//    cout << i << " , " << j << endl;
//    if (i == computers.size() - 1 || j == computers.size() - 1)
//    {
//        answer++;
//        return;
//    }   
...
//        return;
//    }
//    dfs(computers,i,j+1, computers[i][j]);
//    dfs(computers,i+1,j, computers[i][j]);
//}
//int solution(int n, vector<vector<int>> computers) {
//    dfs(computers, 0, 0, 0);
//    return answer;
...
//int main()
//{
//    int a = solution(3, { {1,1,0},{1,1,0},{0,0,1} });
//    cout << a;
//
//}
...
//using namespace std;
//vector<string> answer;
//void dfs(vector<vector<int>>& map, vector<pair<string, int>>pair, int start_in)
//{
//    for (int index_end = 0; index_end < pair.size(); index_end++)
//    {
//        if (map[start_in][index_end] == 1)
//        {
//            answer.push_back(pair[index_end].first);
//            map[start_in][index_end] = 0;
//            dfs(map, pair, index_end);
//        }
//    }
//
//
...
//    for (int i = 0; i < tmp.size(); i++)
//        pair.push_back(make_pair(tmp[i], i));
//
//    vector<vector<int>> map(tmp.size(), vector<int>(tmp.size(), 0));
//    int a = 0, b = 0;
//    for (int i = 0; i < tickets.size(); i++)
//    {
//        int x = 0;
...
//            if (tickets[i][0] == pair[j].first)
//                x = pair[j].second;
//        for (int j = 0; j < pair.size(); j++)
//            if (tickets[i][1] == pair[j].first)
//                y = pair[j].second;
//        if (i == 0)
//        {
//            a = x;
...
//void dfs(vector<vector<int>>& map, vector<pair<string, int>>pair, int start_in)
//{
//    for (int end_index = 0; end_index < pair.size(); end_index++)
//    {
//        if (map[start_in][end_index] != 0)
//        {
//            map[start_in][end_index] = 0;
//            answer.push_back(pair[end_index].first);
//            dfs(map, pair, end_index);
//        }
//    }
//}
//vector<string> solution(vector<vector<string>> tickets) {
...
//int main()
//{
//    vector <vector<string>> t = { {"I", "A"}, {"I", "B"},     {"B", "I"} };
//    vector <string> s = solution(t);
//}
//#include <string>
//#include <iostream>
...
//        for (int j = i + 1; j < tmp.size(); j++)
//        {
//            if (tmp[j] == find_tmp) dupli_idx++;
//            if (tmp[j] == tmp[j - 1]) seq_idx++;
//            else seq_idx = 1;
//            if (seq_idx == 4 && flag4 == 0) flag4 = 1;
//        }
//        if (dupli_idx >= 5) flag5 = 1;
//    }
//}
//
...
//    {
//        if (!((inp_str[i] >= 48 && inp_str[i] <= 57) || \
//            (inp_str[i] >= 65 && inp_str[i] <= 90) || \
//            (inp_str[i] >= 97 && inp_str[i] <= 122) || \
//            (inp_str[i] >= 35 && inp_str[i] <= 38) || \
//            inp_str[i] == 42 || inp_str[i] == 33 || inp_str[i] == 64 || \
//            inp_str[i] == 126)) flag2 = 1;
//
//        if ((inp_str[i] >= 48 && inp_str[i] <= 57) && num_flag == 0) {
//            num_flag = 1;
//            flag3++;
//        }
//        else if ((inp_str[i] >= 65 && inp_str[i] <= 90) && cap_flag == 0) {
//            cap_flag = 1;
//            flag3++;
//        }
//        else if ((inp_str[i] >= 97 && inp_str[i] <= 122) && small_flag == 0) {
//            small_flag = 1;
//            flag3++;
//        }
//        else if ((inp_str[i] >= 35 && inp_str[i] <= 38) || \
//            inp_str[i] == 42 || inp_str[i] == 33 || inp_str[i] == 64 || \
//            inp_str[i] == 126) {
//            spe_flag = 1;
//            flag3++;
//        }
//    }
//    if (flag2 == 1) answer.push_back(2);
//    if (flag3 < 3) answer.push_back(3);
//    dupli(inp_str);
//    if (flag4 == 1) answer.push_back(4);
//    if (flag5 == 1) answer.push_back(5);
//
...
//}
//
//bool is_string(string b)
//{
//    for (int i = 0; i < b.size(); i++)
//    {
//        if (!((b[i] >= 65 && b[i] <= 90) || (b[i] >= 97 && b[i] <= 122))) return false;
//    }
//    return true;
//}
//
...
//            for (; j < v_tmp.size(); j++)
//            {
//                if (rule_map.find(v_tmp[j]) != rule_map.end())
//                {
//                    if (rule_map[v_tmp[j]] == "STRINGS")
//                    {
//                        j++;
//                        if (j >= v_tmp.size())
//                        {
...
//                        }
//                    }
//                    else if (rule_map[v_tmp[j]] == "NUMBERS")
//                    {
//                        j++;
//                        if (j >= v_tmp.size())
//                        {
...
//                        while (1)
//                        {
//                            if (j >= v_tmp.size()) break;
//                            if (v_tmp[j][0] != '-') {
//                                if (is_number(v_tmp[j]) == false)
//                                {
//                                    answer.push_back(false);
//                                    flag = 1;
//                                    break;
...
//                        }
//                    }
//                    else if (rule_map[v_tmp[j]] == "STRING")
//                    {
//                        j++;
//                        if (j >= v_tmp.size())
//                        {
...
//                        }
//                    }
//                    else if (rule_map[v_tmp[j]] == "NUMBER")
//                    {
//                        j++;
//                        if (j >= v_tmp.size())
//                        {
...
//int main()
//{
//    vector<string> f = { "-s STRING", "-num NUMBER", "-e NULL", "-n ALIAS -num" };
//    vector<string> c = { "line -n 100 -s hi -e", "line -n 100 -e -num 150" };
//    vector <bool> s = solution("line",f,c);
//    for (auto i : s)
//        cout << i;
//}
//#include <string>
...
//using namespace std;
//int answer = 9;
//void dfs(int n, int num, int count, int sum)
//{
//    if (count >= 8)
//        return;
//    if (sum == num)
...
//        dfs(n, num, count + 1 + i, sum + tmp_num);
//        dfs(n, num, count + 1 + i, sum - tmp_num);
//        dfs(n, num, count + 1 + i, sum * tmp_num);
//        dfs(n, num, count + 1 + i, sum / tmp_num);
//    }
...
void dfs(int x, int y)
{
    ...
    {
        int nx = x + dx[i]; //위 아래
        int ny = y + dy[i]; // 좌 우 기준으로 탐색을 진행한다.
        if (nx >= n || nx < 0 || ny >= n || ny < 0) // 만약 위,아래,좌,우 한곳이라도 범위를벗어난 경우는 고려하지 않는다.
            continue;
        if (!visit[nx][ny] && arr[nx][ny])
            dfs(nx, ny); // 위에 조건에 일치 하지않으면 위아래좌우 순으로 각 연결된 집을 탐색한다.
    }
}
int main()
{
